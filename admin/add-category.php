...
<head>
    ...
    <title>Admin | Add Course Catagory</title>
    <!-- Favicon icon -->
    ...
    ***********************************-->
    <div id="main-wrapper">
                ...
                <div class="row page-titles mx-0">
                    ...
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><a href="javascript:void(0);">Add Course Catagory</a></li>
                        </ol>
                    </div>
                </div>
					...
					<div class="col-lg-12">
						<div class="card">
							<div class="card-header">
								<h4 class="card-title">Courses Catagory Details</h4>
							</div>
							<div class="card-body">
        ...
        ***********************************-->
        <div class="footer">
            <div class="copyright">
                <p>Copyright © Designed &amp; Developed by <a href="http://appsron.com/" target="_blank">Appsron Technologies</a> 2021</p>
            </div>
        </div>
        <!--**********************************
            Footer end
