        ...
        <div class="main-content">
            ...
            <div class="rs-breadcrumbs breadcrumbs-overlay">
                ...
                <div class="breadcrumbs-text white-color padding">
                    <h1 class="page-title">Dev-ops</h1>
                    <ul>
                        <li>
                    ...
                    <div class="row">                     
                       <div class="col-lg-3 col-md-6 col-sm-6 mb-40">
                           <div class="courses-item">
                               <div class="img-part">
                                   <img src="assets/images/courses/dev-ops/dev-ops.jpeg" alt="">
                               </div>
                               <div class="content-part">
                                <span><a class="categories" href="#">&#8377 5599/-</a></span>
                                   ...
                                   <h3 class="title"><a href="dev-ops-engineer.html">Dev-Ops Engineer</a></h3><br>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6 mb-40">
                            <div class="courses-item">
                                <div class="img-part">
                                    <img src="assets/images/courses/dev-ops/ml-ops.jpeg" alt="">
                                </div>
                                <div class="content-part">
                                    <span><a class="categories" href="#">&#8377 5599/-</a></span>
                                    <ul class="meta-part">
                                    ...
                                    <h3 class="title"><a href="ml-ops.html">ML-Ops for Data Science</a></h3>
                                    <div class="bottom-part">
                                        <div class="info-meta">
                                            <ul>                                                
                                                <li class="ratings">
