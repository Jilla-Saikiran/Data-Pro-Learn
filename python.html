                                            ...
                                            <li class="menu-item-has-children current-menu-item">
                                                ...
                                                <ul class="sub-menu"> 
                                                    ...
                                                    <ul class="sub-menu right">
                                                        <li class="current-menu-item"><a href="python.html">Python
                                            ...
                                            <div class="course-overview">
                                                <div class="inner-box">
                                                    ...
                                                    <ul class="review-list">
                                                        ...
                                                        <li>For loop</li>
                                                        <li>Data Handling in Python</li>
                                                        <li>Data import from CSV files</li>
                                                        <li>Data import from Excel files</li>
                                                        <li>LAB:Basic Commands on Datasets</li>
                                                        <li>Sub setting the data</li>
                                                        <li>Lab: Sub setting the data</li>
                                                        <li>Subset with variable filter conditions</li>
                                                        <li>Lab: Subset with variable filter conditions</li>
                                                        <li>Sorting the data</li>
                                                        <li>Identifying Duplicates</li>
                                                        <li>Data Joins</li>
                                                        <li>Basic Statistics and Reporting in Python</li>
                                                        <li>Sampling in Python</li>
                                                        <li>Descriptive statistics</li>
                                                        <li>Mean and Median on python</li>
                                                        <li>Dispersion Measures</li>
                                                        <li>Percentiles & Quartiles</li>
                                                        <li>Box plots and outlier detection</li>
                                            ...
                                            <div id="accordion3" class="accordion-box">
                                                <div class="card accordion block">
                                                    <div class="card-header" id="headingSeven">
                                                        <h5 class="mb-0">
                                                            <button class="btn btn-link acc-btn" data-toggle="collapse" data-target="#collapseSeven" aria-expanded="true" aria-controls="collapseSeven">What are the requirements</button>
                                                        </h5>
                                                    </div>
                                                    ...
                                                    <div id="collapseSeven" class="collapse show" aria-labelledby="headingSeven" data-parent="#accordion3">
                                                        <div class="card-body acc-content current">
                                                            <div class="content">
                                                                <div class="clearfix">
                                                                    <div class="pull-left">
                                                                        <P>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Dolorem corrupti veniam sint tempora! Illum expedita nulla, sunt deserunt reiciendis ratione.
                                                                        </P>
                                                                    </div>
                        ...
                        <div class="video-column col-lg-4">
                            ...
                            <!-- Video Box -->
                                <div class="intro-video media-icon orange-color2">
                                    <img class="video-img" src="assets/images/courses/programming/py.jpeg" alt="Video Image">
                                ...
                                <div class="btn-part">
                                    <a href="#" class="btn readon2 orange">&#8377 5599/-</a></a>
                                    <a href="checkout.html" class="btn readon2 orange-transparent">Buy Now</a>
                                </div>
                            </div>
                        </div>                        
                    </div>                
