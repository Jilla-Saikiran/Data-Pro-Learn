            ...
            <header id="rs-header" class="rs-header">
                ...
                <nav class="right_menu_togle hidden-md">
                    ...
                    <div class="canvas-logo">
                        <a href="index-2.php"><img src="assets/images/dark-logo.png" alt="logo"></a>
                    </div>
                ...
                <div class="container">
                    <div class="register-box">
                        ...
                        <div class="styled-form">
                            ...
                            <form id="contact-form" method="POST" action="register-db.php">                               
                                <div class="row clearfix">                                    
                                    ...
                                    <!-- Form Group -->
                                    <div class="form-group col-lg-12">
                                        <input type="text" id="phone_number" name="phone_number" value="" placeholder="Phone Number" required>
                                    </div>    
                                    <!-- Form Group -->
                                    <div class="form-group col-lg-12">
