...
<head> 
        ...
        <title>Statistics,
            MachineLearning,
            NLP-Python-R-BigData-Spark</title>
                                           ...
                                           <li > <a href="index.php">Home</a></li>
                                            ...
                                            <li class="menu-item-has-children current-menu-item">
                                                ...
                                                <ul class="sub-menu"> 
                                                    ...
                                                    <li class="current-menu-item"><a href="data-science.html">Data Science & AI</a> 
                                                        <ul class="sub-menu right">
                                                            ...
                                                            <li class="current-menu-item"><a href="NLP-Python-R-BigData-Spark.html">Statistics,
                                                                MachineLearning,
                                            ...
                                            <li class="menu-item-has-children">
                                               ...
                                               <li>
                                                <a href="blog-single.html">Blog</a></li>
                                            ...
                                            <div class="woocommerce-mini-cart text-left">
                                                <div class="cart-bottom-part">
                                                    <ul class="cart-icon-product-list">
                                                        <li class="display-flex">
                                                            ...
                                                            <div class="product-info">
                                                                ...
                                                                <span class="quantity">1 × &#8377 24999.00/-</span>
                                                            </div>
                                                    ...
                                                    <div class="total-price text-center">
                                                        ...
                                                        <span class="current-price">&#8377 49998.00/-</span>
                                                    </div>
                                        ...
                                        <div class="content white-bg pt-30">
                                            ...
                                            <div class="course-overview">
                                                <div class="inner-box">
                                                    ...
                                                    <p>Machine Learning is an interdisciplinary field that uses statistics, probability, algorithms to learn from data and provide insights which can be used to build intelligent applications. ... Probability and statistics are related areas of mathematics which concern themselves with analyzing the relative frequency of events.</p>
                                                    <p>Natural language processing (NLP) is a field that focuses on making natural human language usable by computer programs. NLTK, or Natural Language Toolkit, is a Python package that you can use for NLP. A lot of the data that you could be analyzing is unstructured data and contains human-readable text.</p>
                                                    ...
                                                    <ul class="review-list">
                                                        ...
                                                        <li>Data Types</li>
                                                        <li>Integer and Numeric Data Types</li>
                                                        <li>Logical Data Types</li>
                                                        <li>Character Data Types</li>
                                                        <li>Factor Data Types</li>
                                                        <li>Complex Data Types</li>
                                                        <li>Date Data Types</li>
                                                        <li>Data Strectures</li>
                                                        <li>Vectors</li>
                                                        <li>matrix</li>
                                                        <li>array</li>
                                                        <li>lists</li>
                                                        ...
                                                        <li>Function call with no arguments</li>
                                                        <li>Function with 2 arguments but no defaults</li>
                                                        <li>Defining functions with defaults </li>
                                                        <li>Ignoring the excessive arguments</li>
                                                        <li>Local Vs Global variables</li>
                                                        <li>Passing a function as a argument</li>
                                                        <li>Apply</li>
                                                        <li>Aggregate Functions</li>
                                                        <li>lapply with ggplot2</li>
                                                        <h3>Stat Basics</h3>
                                                        <li>Frequency Distributions and Measures of central Tendency</li>
                                                        <li>Measures of Dispersion, Skewness and Kurtosis</li>
                                                        <li>Curve Fitting and Principle of Least Squares</li>
                                                        <li>Sampling and Large Sample Tests</li>
                                                        <li>Exact Sampling Distributions - Chi-Square, t, F and z distributions</li>
                                                        <li>Statistical Inference - I(Theory of Estimation)</li>
                                                        <li>Statistical Inference – II Testing of Hypothesis, Non-parametric Methods</li>
                                                        <li>Correlation and Regression</li>
                                                        <li>Modelling, Prediction and Forecasting</li>
                                                        <li>Machine learning algorithms</li>
                                                        <li>What is Hypothesis Testing</li>
                                                        <li>Choosing a Statistical Technique</li>
                                                        <li>One-tailed and two-tailed tests</li>
                                                        <li>Procedure for Testing of Hypothesis</li>
                                                        <li>Difference between these three terms, Confidence Interval, Confidence Limits and Confidence Level</li>
                                                        <li>Degrees of Freedom</li>
                                                            
                                                        <h3>Machine Learning</h3>
                                                        <li>What is ML and why it is Used</li>
                                                        <li>Basics of ML</li>
                                                        <li>What is Predective Modeling & why it is used</li>
                                                        <li>What is text analytics & why it is used</li>
                                                        <li>Regression Models (Linear Regression , Logistic Regression)</li>
                                                        <li>Decession Trees</li>
                                                        <li>Time Series Models</li>
                                                        <li>Clustering techniques</li>
                                                        <li>Boosting techniques</li>
                                                        <li>Deep Learning & Neuralnet works and how they work</li>
                                                        <h3>Python ML</h3>
                                                        ...
                                                        <li>SVM</li>
                                                            <h3>Basic computations in R</h3>
                                                        <li>Essentials of R Programming</li>
                                                        <li>Data Types and Objects in R</li>
                                                        <li>DataStructures,basicfunctions, apply</li>
                                                        <li>Control Structures (Functions) in R</li>
                                                        <li>Useful R Packages</li>
                                                            <h3>Exploratory Data Analysis in R</h3>
                                                        <li>Basic Graphs</li>
                                                        <li>Treating Missing values</li>
                                                        <li>Working with Continuous and Categorical Variables</li>
                                                            <h3>Data Manipulation in R</h3>
                                                        <li>Feature Engineering</li>
                                                        <li>Label Encoding / One Hot Encoding</li>
                                                            <h3>Predictive Modeling using Machine Learning in R & Python(with Assignments)</h3>
                                                        <li>Linear Regression</li>
                                                        <li>Logistic Regression</li>
                                                        <li>Clustering</li>
                                                        <li>KNN</li>
                                                        <li>Model EvolutionTechniques</li>
                                                        <li>Assosiation Rules</li>
                                                        <li>Decision Tree</li>
                                                        <li>Random Forest</li>
                                                        <li>XGBoost</li>
                                                        <li>Neural-Networks</li>
                                                        ...
                                                        <li>Time Series</li>
                                                            <h3>NLP</h3>
                                                        <li>Scentiment Analysis</li>
                                                        <li>Twitter Analysis</li>
                                                        <h3>Hadoop</h3>
                                                        <li>Introduction to Big Data</li>
                                                        <li>Understanding Hadoop Cluster</li>
                                                        <li>HDFS Archetecture</li>
                                                        <li>MapReduce</li>
                                                        <li>PIG</li>
                                                        <li>UDF's</li>
                                                        <li>Hive</li>
                                                        <li>Hive UDF's</li>
                                                        <li>Partitions & Buckets</li>
                                                        ...
                                                        <li>Unit Testing</li>
                                                        <li>Migrating from pre-1.0 Versions of Spark</li>
                                                        <li>Where to Go from Here</li>
                                                    </ul>
                                                    <h3>Prerequisites to learn data Science </h3>
                                                    <ul class="review-list">
                                                        <li>Although there are no strict prerequisites to learn or commence Data Science training , the following skills will enable students to ramp up faster during training 
                                                        <li>Basic programming skills</li>
                                                        <li>Basic maths and statistical concepts understanding </li>
                                                        <li>Basic knowledge of SQL and database concepts</li>
                                                        <li>Interest and aptitude in dealing with huge amounts of data and numbers</li> 
                                                        <li>Curiosity and creativity in understanding data and how they help an organization take better business decisions</li>
                                                        <li>Note: Above pre requisites are NOT mandatory for the training & will be discussed in detail during the training.</li>
                                                        <li>PC or Mac</li>
                        ...
                        <div class="video-column col-lg-4">
                            ...
                            <!-- Video Box -->
                                <div class="intro-video media-icon orange-color2">
                                    <img class="video-img" src="assets/images/courses/datascience/bdml.jpeg" alt="Video Image">
                                ...
                                <div class="btn-part">
                                    <a href="#" class="btn readon2 orange">&#8377 5599/-</a>
