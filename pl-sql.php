                                            ...
                                            <li class="menu-item-has-children current-menu-item">
                                                ...
                                                <ul class="sub-menu"> 
                                                    ...
                                                    <li class="current-menu-item"><a href="business.html">Business Analytics</a> 
                                                        <ul class="sub-menu right">
                                                            <li class="current-menu-item"><a href="pl-sql.html">SQL PL-SQL</a></li>
        ...
        <div class="main-content">
            ...
            <div class="rs-breadcrumbs breadcrumbs-overlay ">
                ...
                <div class="breadcrumbs-text white-color padding">
                    <h1 class="page-title">SQL PL-SQL</h1>
                    <ul>
                        <li>
                        ...
                        <div class="video-column col-lg-4">
                            ...
                            <!-- Video Box -->
                                <div class="intro-video media-icon orange-color2">
                                    <img class="video-img" src="assets/images/courses/Business-Analytics/sql.jpeg" alt="Video Image">
