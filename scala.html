                                            ...
                                            <li class="menu-item-has-children current-menu-item">
                                                ...
                                                <ul class="sub-menu"> 
                                                    ...
                                                    <ul class="sub-menu right">
                                                        ...
                                                        <li class="current-menu-item"><a href="scala.html">Scala
                                                            (Beginner Level to Master)
                                                        </a></li>
                                                      </ul>
                                                    </li>
        ...
        <div class="main-content">
            ...
            <div class="rs-breadcrumbs breadcrumbs-overlay ">
                ...
                <div class="breadcrumbs-text white-color padding">
                    <h1 class="page-title">Scala (Beginner Level To Master) </h1>
                    <ul>
                        <li>
                                        ...
                                        <div class="content white-bg pt-30">
                                            ...
                                            <div class="course-overview">
                                                <div class="inner-box">
                                                    ...
                                                    <p>Scala is a general-purpose, high-level, multi-paradigm programming language. It is a pure object-oriented programming language which also provides support to the functional programming approach.<br> Scala programs can convert to bytecodes and can run on the JVM(Java Virtual Machine). Scala stands for Scalable language.</p>
                                                    ...
                                                    <ul class="review-list">
                                                        <li>understand Scala code in production environments or open-source projects</li>
                                                        <li>think code differently with functional programming</li>
                                                        <li>write applications in Scala from scratch</li>
                                                        <li>contribute to products and open-source projects written in Scala</li>
                                                        <li>skills to start developing with powerful tools on top of Scala: Spark, Akka, Play</li>
                                                    </ul>
                                                    <h3>Requirements</h3>
                                                    <ul class="review-list">
                        ...
                        <div class="video-column col-lg-4">
                            ...
                            <!-- Video Box -->
                                <div class="intro-video media-icon orange-color2">
                                    <img class="video-img" src="assets/images/courses/programming/scala.jpeg" alt="Video Image">
