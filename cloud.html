                            ...
                            <div class="col-md-7">
                                <ul class="topbar-contact">
                                    <li>
                                        ...
                                        <a href="learn@dataprolearn.com">learn@dataprolearn.com</a>
                                    </li>
                                    <li>
                    ...
                    <div class="row">                     
                       <div class="col-lg-3 col-md-6 col-sm-6 mb-40">
                           <div class="courses-item">
                               <div class="img-part">
                                   <img src="assets/images/courses/cloud/az-204.png" alt="">
                               </div>
                               <div class="content-part">
                                <span><a class="categories" href="#">&#8377 5599/-</a></span>
                                   ...
                                   <h3 class="title"><a href="course-single.html">AZ-204 - Developing Solutions for Microsoft Azure</a></h3>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6 mb-40">
                            <div class="courses-item">
                                <div class="img-part">
                                    <img src="assets/images/courses/cloud/azure.jpeg" alt="">
                                </div>
                                <div class="content-part">
                                    <span><a class="categories" href="#">&#8377 5599/-</a></span>
                                    <ul class="meta-part">
                                    ...
                                    <h3 class="title"><a href="course-single.html">AZ-304 - Microsoft Azure Architect Design</a></h3><br>
                                    <div class="bottom-part">
                                        <div class="info-meta">
                                            <ul>                                                
                                                <li class="ratings">
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6 mb-40">
                            <div class="courses-item">
                                ...
                                <div class="content-part">
                                    ...
                                    <h3 class="title"><a href="course-single.html">Exam AZ-400: Designing and Implementing Microsoft DevOps Solutions</a></h3><br>
                                    <div class="bottom-part">
                                        <div class="info-meta">
                                            <ul>                                                
                                                <li class="ratings">
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6 mb-40">
                            <div class="courses-item">
                                ...
                                <div class="content-part">
                                    ...
                                    <h3 class="title"><a href="course-single.html">DataBricks - Spark (Scala) PySpark (Python)</a></h3><br>
                                    <div class="bottom-part">
                                        <div class="info-meta">
                                            <ul>                                                
                                                <li class="ratings">
