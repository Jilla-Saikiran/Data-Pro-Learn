                                           ...
                                           <li > <a href="index.php">Home</a></li>
                                            ...
                                            <li class="menu-item-has-children current-menu-item">
                                                ...
                                                <ul class="sub-menu"> 
                                                    ...
                                                    <li class="current-menu-item"><a href="cloud.php">Cloud</a> 
                                                        <ul class="sub-menu right">
                                                            ...
                                                            <li class="current-menu-item"><a href="az-404.php">Exam AZ-400: Designing and Implementing Microsoft DevOps Solutions</a></li>
                                                            <li><a href="data-bricks.php">DataBricks - Spark (Scala) PySpark (Python)</a></li>
                                                          </ul>
                                                    </li>
