                           ...
                           <div class="courses-item">
                               ...
                               <div class="content-part">
                                <span><a class="categories" href="#">&#8377 5599/-</a></span>
                                   ...
                                   <h3 class="title"><a href="course-single.php">Statistics,Machine Learning & NLP-Python</a></h3><br>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6 mb-40">
                            <div class="courses-item">
                                ...
                                <div class="content-part">
                                    ...
                                    <h3 class="title"><a href="course-single.php"> Statistics,Machine Learning & NLP with R</a></h3><br>
                                    <div class="bottom-part">
                                        <div class="info-meta">
                                            <ul>                                                
                                                <li class="ratings">
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6 mb-40">
                            <div class="courses-item">
                                ...
                                <div class="content-part">
                                    ...
                                    <h3 class="title"><a href="course-single.php">Statistics,<br>MachineLearning,<br>NLP-Python-R-BigData-Spark</a></h3>
                                    <div class="bottom-part">
                                        <div class="info-meta">
                                            <ul>                                                
                                                <li class="ratings">
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6 md-mb-30">
                            <div class="courses-item">
                                ...
                                <div class="content-part">
                                    ...
                                    <h3 class="title"><a href="course-single.php">Deep learning with TensorFlow</a></h3><br><br>
                                    <div class="bottom-part">
                                        <div class="info-meta">
                                            <ul>                                                
                                                <li class="ratings">
