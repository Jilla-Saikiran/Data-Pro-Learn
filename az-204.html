                                            ...
                                            <li class="menu-item-has-children current-menu-item">
                                                ...
                                                <ul class="sub-menu"> 
                                                    ...
                                                    <li class="current-menu-item"><a href="cloud.html">Cloud</a> 
                                                        <ul class="sub-menu right">
                                                            <li class="current-menu-item"><a href="az-204.html">AZ-204 - Developing Solutions for Microsoft Azure</a></li>
        ...
        <div class="main-content">
            ...
            <div class="rs-breadcrumbs breadcrumbs-overlay ">
                ...
                <div class="breadcrumbs-text white-color padding">
                    <h1 class="page-title">AZ-204 - Developing Solutions for Microsoft Azure</h1>
                    <ul>
                        <li>
                        ...
                        <div class="video-column col-lg-4">
                            ...
                            <!-- Video Box -->
                                <div class="intro-video media-icon orange-color2">
                                    <img class="video-img" src="assets/images/courses/cloud/az-204.png" alt="Video Image">
