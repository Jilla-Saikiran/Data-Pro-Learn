                                                    ...
                                                    <li><a href="data-science.html">Data Science & AI</a> 
                                                        <ul class="sub-menu right">
                                                            ...
                                                            <li><a href="NLP-Python-R-BigData-Spark.html">Statistics,
                                                                ...
                                                                <li><a href="Deep-learning-with-TensorFlow">Deep learning with TensorFlow</a></li>
                                                          </ul>
                                                    </li>
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-12 col-sm-12 footer-widget md-mb-50">
                            <div class="footer-logo mb-30">
                                <a href="index.html"><img src="assets/images/footer-logo.png" alt="Data Pro Learn"></a>
                            </div>
