                            ...
                            <table class="cart-table">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="product-thumbnail"><a href="#"><img src="assets/images/courses/programming/py.jpeg" alt=""></a></td>
                                        <td class="product-name"><a href="#">Python</a></td>
                                        <td class="product-price"><span>&#8377</span>5999/-</td>
                                        <td class="product-quantity"><input type="text" class="input-text" value="1" pattern="[0-9]*"></td>
                                        <td class="subtotal"><span class="amount"><span class="symbol">&#8377</span>5999/-</span></td>
                                        <td><button class="btn btn-danger" type="button">Remove</button></td>
                                    </tr>
                                    <tr>
                                        
                                        <td class="product-thumbnail"><a href="#"><img src="assets/images/courses/datascience/mlp.png" alt=""></a></td>
                                        <td class="product-name"><a href="#">Data Science</a></td>
                                        <td class="product-price"><span>&#8377</span>5999/-</td>
                                        <td class="product-quantity"><input type="text" class="input-text" value="1" pattern="[0-9]*"></td>
                                        <td class="subtotal"><span class="amount"><span class="symbol">&#8377</span>5999/-</span></td>
                                        <td><button class="btn btn-danger" type="button">Remove</button></td>
                                ...
                                <table class="cart-total-table">
                                    <tbody>
                                        <tr class="cart-subtotal">
                                            <th>Subtotal</th>
                                            <td><span class="amount"><span>&#8377</span>11998/-</span></td>
                                        </tr>
                                        <tr class="order-total">
                                            <th>Total</th>
                                            <td><strong><span class="amount"><span>&#8377</span>11998/-</span></strong></td>
                                        </tr>
                                    </tbody>
                                </table>
