                                                ...
                                                <ul class="sub-menu"> 
                                                    ...
                                                    <li class="current-menu-item"><a href="data-science.html">Data Science & AI</a> 
                                                        <ul class="sub-menu right">
                                                            ...
                                                            <li class="current-menu-item"><a href="machine-learning-r.html">Statistics,Machine Learning & NLP with R</a></li>
        ...
        <div class="main-content">
            ...
            <div class="rs-breadcrumbs breadcrumbs-overlay ">
                ...
                <div class="breadcrumbs-text white-color padding">
                    <h1 class="page-title">Statistics,Machine Learning & NLP with R</h1>
                    <ul>
                        <li>
                        ...
                        <div class="video-column col-lg-4">
                            ...
                            <!-- Video Box -->
                                <div class="intro-video media-icon orange-color2">
                                    <img class="video-img" src="assets/images/courses/datascience/mlr.jpeg" alt="Video Image">
