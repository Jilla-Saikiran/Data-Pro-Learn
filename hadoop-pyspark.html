...
<head> 
        <!-- meta tag -->
        <meta charset="utf-8">
        <title>Hadoop Spark-Pyspark</title>
                                            ...
                                            <li class="menu-item-has-children current-menu-item">
                                                ...
                                                <ul class="sub-menu"> 
                                                    ...
                                                    <li class="current-menu-item"><a href="big-data.html">Big Data & Data Ware House</a> 
                                                        <ul class="sub-menu right">
                                                            <li class="current-menu-item"><a href="hadoop-pyspark.html">Hadoop - Spark & PySpark</a></li>
        ...
        <div class="main-content">
            ...
            <div class="rs-breadcrumbs breadcrumbs-overlay ">
                ...
                <div class="breadcrumbs-text white-color padding">
                    <h1 class="page-title">Hadoop - Spark & PySpark</h1>
                    <ul>
                        <li>
                        ...
                        <div class="video-column col-lg-4">
                            ...
                            <!-- Video Box -->
                                <div class="intro-video media-icon orange-color2">
                                    <img class="video-img" src="assets/images/courses/bigdata/Hadoop.jpeg" alt="Video Image">
