                                           ...
                                           <li > <a href="index.php">Home</a></li>
                                            ...
                                            <li class="menu-item-has-children current-menu-item">
                                                ...
                                                <ul class="sub-menu"> 
                                                    ...
                                                    <li class="current-menu-item"><a href="cloud.html">Cloud</a> 
                                                        <ul class="sub-menu right">
                                                            ...
                                                            <li class="current-menu-item"><a href="az-404.html">Exam AZ-400: Designing and Implementing Microsoft DevOps Solutions</a></li>
                                                            <li><a href="data-bricks.html">DataBricks - Spark (Scala) PySpark (Python)</a></li>
                                                          </ul>
                                                    </li>
        ...
        <div class="main-content">
            ...
            <div class="rs-breadcrumbs breadcrumbs-overlay ">
                ...
                <div class="breadcrumbs-text white-color padding">
                    <h1 class="page-title">Exam AZ-400: Designing and Implementing Microsoft DevOps Solutions
                    </h1>
                    <ul>
                        <li>
                        ...
                        <div class="video-column col-lg-4">
                            ...
                            <!-- Video Box -->
                                <div class="intro-video media-icon orange-color2">
                                    <img class="video-img" src="assets/images/courses/cloud/azure.jpeg" alt="Video Image">
