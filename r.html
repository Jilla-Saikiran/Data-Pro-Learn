                                        ...
                                        <ul class="nav-menu">
                                           <li > <a href="index.php">Home</a></li>
                                            ...
                                            <li class="menu-item-has-children current-menu-item">
                                                ...
                                                <ul class="sub-menu"> 
                                                    <li class="current-menu-item"><a href="programming.html">Programming</a> 
                                                    <ul class="sub-menu right">
                                                        <li><a href="python.html">Python
                                                            (Beginner Level to Master)
                                                        </a></li>
                                                        <li class="current-menu-item"><a href="r.html">R
        ...
        <div class="main-content">
            ...
            <div class="rs-breadcrumbs breadcrumbs-overlay ">
                ...
                <div class="breadcrumbs-text white-color padding">
                    <h1 class="page-title">R Programming <br>(Beginner level to Master Level)</h1>
                    <ul>
                        <li>
                                        ...
                                        <div class="content white-bg pt-30">
                                            ...
                                            <div class="course-overview">
                                                <div class="inner-box">
                                                    ...
                                                    <p>In Introduction to R, you will master the basics of this widely used open source language, including factors, lists, and data frames. With the knowledge gained in this course, you will be ready to undertake your first very own data analysis.<br> Oracle estimated over 2 million R users worldwide in 2012, cementing R as a leading programming language in statistics and data science. Every year, the number of R users grows by about 40%, and an increasing number of organizations are using it in their day-to-day activities. Begin your journey to learn R with us today!
                                                    ...
                                                    <ul class="review-list">
                                                        <li>Learn to program in R at a good level</li>
                                                        <li>Learn how to use R Studio</li>
                                                        <li>Learn the core principles of programming</li>
                                                        <li>Learn how to create vectors in R</li>
                                                        <li>Learn how to create variables</li>
                                                        <li>Learn about integer, double, logical, character and other types in R</li>
                                                        <li>Learn how to create a while() loop and a for() loop in R</li>
                                                        <li>Learn how to build and use matrices in R</li>
                                                        <li>Learn the matrix() function, learn rbind() and cbind()</li>
                                                        <li>Learn how to install packages in R</li>
                                                        <li>Learn how to customize R studio to suit your preferences</li>
                                                        <li>Understand the Law of Large Numbers</li>
                                                        <li>Understand the Normal distribution</li>
                                                        <li>Practice working with statistical data in R</li>
                                                        <li>Practice working with financial data in R</li>
                                                        <li>Practice working with sports data in R</li>
                                                    </ul>
                                                    <h3>Requirements</h3>
                                                    <ul class="review-list">
                                                        <li>Basic Knoladge of Programming</li>
                                                        <li>Pc or Mac</li>
                        ...
                        <div class="video-column col-lg-4">
                            ...
                            <!-- Video Box -->
                                <div class="intro-video media-icon orange-color2">
                                    <img class="video-img" src="assets/images/courses/programming/R-programming-language.jpeg" alt="Video Image">
