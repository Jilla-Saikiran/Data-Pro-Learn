                           ...
                           <div class="courses-item">
                               ...
                               <div class="content-part">
                                <span><a class="categories" href="#">Programming</a></span>
                                   ...
                                   <h3 class="title"><a href="python.php"> Python<br>(Beginner Level to Master)</a></h3>
                       ...
                       <div class="col-lg-3 col-md-6 col-sm-6 mb-40">
                        <div class="courses-item">
                            ...
                            <div class="content-part">
                                ...
                                <h3 class="title"><a href="python.php"> R<br>(Beginner Level to Master)</a></h3>
                                <div class="bottom-part">
                                    <div class="info-meta">
                                        <ul>                                                
                                            <li class="ratings">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 mb-40">
                        <div class="courses-item">
                            ...
                            <div class="content-part">
                                ...
                                <h3 class="title"><a href="python.php">Scala<br>(Beginner Level to Master)</a></h3>
                                <div class="bottom-part">
                                    <div class="info-meta">
                                        <ul>                                                
                                            <li class="ratings">
