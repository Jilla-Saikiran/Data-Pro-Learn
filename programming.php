            ...
            <div class="container">                  
                <div class="row">                     
                       <div class="col-lg-3 col-md-6 col-sm-6 mb-40">
                           <div class="courses-item">
                               ...
                               <div class="content-part">
                                <span><a class="categories" href="#">Programming</a></span>
                                   <ul class="meta-part">
                                       <li class="user"><i class="fa fa-user"></i> 245</li>
                                       <span class="price">&#8377 5599/-</span>
                                   </ul>
                                   <h3 class="title"><a href="python.html"> Python<br>(Beginner Level to Master)</a></h3>
                       ...
                       <div class="col-lg-3 col-md-6 col-sm-6 mb-40">
                        <div class="courses-item">
                            <div class="img-part">
                                <img src="assets/images/courses/programming/R-programming-language.jpeg" alt="">
                            </div>
                            <div class="content-part">
                                ...
                                <h3 class="title"><a href="python.html"> R<br>(Beginner Level to Master)</a></h3>
                                <div class="bottom-part">
                                    <div class="info-meta">
                                        <ul>                                                
                                            <li class="ratings">
                                    ...
                                    <div class="btn-part">
                                        <a href="python.html">Apply Now<i class="flaticon-right-arrow"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 mb-40">
                        <div class="courses-item">
                            <div class="img-part">
                                <img src="assets/images/courses/programming/scala.jpeg" alt="">
                            </div>
                            <div class="content-part">
                                <span><a class="categories" href="#">&#8377 5599/-</a></span>
                                <ul class="meta-part">
                                ...
                                <h3 class="title"><a href="python.html">Scala<br>(Beginner Level to Master)</a></h3>
                                <div class="bottom-part">
                                    <div class="info-meta">
                                        <ul>                                                
                                            <li class="ratings">
