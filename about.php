...
<!-- About Section Start -->
<div id="rs-about" class="rs-about style1 pt-100 pb-90 md-pt-70 md-pb-70">
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-lg-6 pr-70 md-pr-15">
                <div class="sec-title">
                    <div class="sub-title orange">About Data Pro Learn</div>
                    <h2 class="title mb-17">Welcome to The Data Pro Learn Online Learning</h2>
                    <div class="bold-text mb-22">Our Speciality is providing ONE TO ONE Custom Trainings based on Learners Background & Career Golas.</div>
                    <div class="desc">Our Aim is to Build a stong community of people to learn the advanced technologies in-demand and industry-ready skills, and to add value to their professional journey.<br>We work on Converge the latest technologies and effective pedagogy to impart high quality Learning to our Community Members</div>
                </div>
            </div>
        </div>
    </div>
...
<!-- About Section End -->
            ...
            <div id="rs-about" class="rs-about style3 pt-90 md-pt-70 pb-70">
                <div class="container">
                    <div class="row y-middle">
                        <div class="col-lg-4 lg-pr-0 md-mb-30">
                            <div class="about-intro">
                                <div class="sec-title">
                                    ...
                                    <div class="desc big">DataProLearn is an Community based organisation and has educated more than 5,000+ learners in SMAC Technologies such as Big Data, Mobility, Analytics & Cloud.<br>And has trained employees of 15+ reputed Corporate organizations.
                            ...
                            <div class="row rs-counter couter-area">
                                <div class="col-md-4 sm-mb-30">
                                    <div class="counter-item one">
                                        ...
                                        <h2 class="number rs-count kplus">5</h2>
            ...
            <div class="rs-testimonial style3 orange-color pt-90 md-pt-70 pb-70">
                <div class="container">
