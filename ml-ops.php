                                                ...
                                                <ul class="sub-menu"> 
                                                    ...
                                                    <li class="current-menu-item"><a href="dev-ops.html">Dev-ops</a> 
                                                        <ul class="sub-menu right">
                                                            ...
                                                            <li class="current-menu-item"><a href="ml-ops.html">ML-Ops for Data Science</a></li>
                                                        </ul>
                                                    </li>
                                                 </ul>
                                            </li>
        ...
        <div class="main-content">
            ...
            <div class="rs-breadcrumbs breadcrumbs-overlay ">
                ...
                <div class="breadcrumbs-text white-color padding">
                    <h1 class="page-title">ML-ops Engineering</h1>
                    <ul>
                        <li>
                            <a class="active" href="index.php">Home</a>
                        </li>
                        <li>ML-ops Engineering</li>
                    </ul>
                </div>
            </div>
            <!-- Breadcrumbs End -->            
                        ...
                        <div class="video-column col-lg-4">
                            ...
                            <!-- Video Box -->
                                <div class="intro-video media-icon orange-color2">
                                    <img class="video-img" src="assets/images/courses/dev-ops/ml-ops.jpeg" alt="Video Image">
