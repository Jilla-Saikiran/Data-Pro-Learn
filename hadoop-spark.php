                                           ...
                                           <li > <a href="index.php">Home</a></li>
                                            ...
                                            <li class="menu-item-has-children current-menu-item">
                                                ...
                                                <ul class="sub-menu"> 
                                                    ...
                                                    <li class="current-menu-item"> <a href="big-data.html">Big Data & Data Ware House</a> 
                                                        <ul class="sub-menu right">
                                                            <li><a href="hadoop-pyspark.html">Hadoop - Spark & PySpark</a></li>
                                                            <li class="current-menu-item"><a href="hadoop-spark.html">Hadoop - Spark for Data Engineering & DWH</a></li>
        ...
        <div class="main-content">
            ...
            <div class="rs-breadcrumbs breadcrumbs-overlay ">
                ...
                <div class="breadcrumbs-text white-color padding">
                    <h1 class="page-title">Hadoop - Spark for Data Engineering & DWH</h1>
                    <ul>
                        <li>
                                        ...
                                        <div class="content white-bg pt-30">
                                            ...
                                            <div class="course-overview">
                                                <div class="inner-box">
                                                    ...
                                                    <p>Hadoop is an Apache project (i.e. an open-source software) to store & process Big Data. Hadoop stores Big Data in a distributed & fault-tolerant manner over commodity hardware. Afterward, Hadoop tools are used to perform parallel data processing over HDFS (Hadoop Distributed File System).
                                                        ...
                                                        Edureka Big Data Hadoop Training is designed to make you a certified Big Data practitioner by providing you rich hands-on training on Hadoop Ecosystem. This Big Data Hadoop online training is a stepping stone to your Big Data journey and you will get the opportunity to work on various Big Data projects.</p>
                                                    ...
                                                    <li>1 Hadoop Course Overview</li>
                                                    <li>2 Hadoop Training Course Prerequisites</li>
                                                    <li>3 Hadoop Course System Requirements</li>
                                                    <li>4 Hadoop Training Course Duration</li>
                                                    <li>5 Hadoop Course Content</li>
                                                    ...
                                                    <li>5.6 Map Reduce Programming – Java Programming</li>
                                                    <li>5.7 NOSQL</li>
                                                    <li>5.8 HBase</li>
                                                    <li>5.9 Hive</li>
                                                    <li>5.10 Pig</li>
                                                   ...
                                                   <h3>Spark Overview</h3>
                                                    <li>Linking with Spark, Initializing Spark</li>
                                                    ...
                                                    <h3>Requirements</h3>
                                                    <ul class="review-list">
                                                        <li>Basic Programming Knowladge</li>
                                                        <li>PC or Mac</li>
                        ...
                        <div class="video-column col-lg-4">
                            ...
                            <!-- Video Box -->
                                <div class="intro-video media-icon orange-color2">
                                    <img class="video-img" src="assets/images/courses/bigdata/hadoop-vs-spark.jpeg" alt="Video Image">
