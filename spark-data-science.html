                                                ...
                                                <ul class="sub-menu"> 
                                                    ...
                                                    <li class="current-menu-item"><a href="big-data.html">Big Data & Data Ware House</a> 
                                                        <ul class="sub-menu right">
                                                            ...
                                                            <li class="current-menu-item"><a href="spark-data-science.html">Spark for Data Science - Machine Learning & NLP</a></li>
        ...
        <div class="main-content">
            ...
            <div class="rs-breadcrumbs breadcrumbs-overlay ">
                ...
                <div class="breadcrumbs-text white-color padding">
                    <h1 class="page-title">Spark for Data Science - Machine Learning & NLP</h1>
                    <ul>
                        <li>
                        ...
                        <div class="video-column col-lg-4">
                            ...
                            <!-- Video Box -->
                                <div class="intro-video media-icon orange-color2">
                                    <img class="video-img" src="assets/images/courses/bigdata/spark.jpeg" alt="Video Image">
