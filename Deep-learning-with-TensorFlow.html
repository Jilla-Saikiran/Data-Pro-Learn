                                                    ...
                                                    <li class="current-menu-item"><a href="data-science.html">Data Science & AI</a> 
                                                        <ul class="sub-menu right">
                                                            ...
                                                            <li><a href="NLP-Python-R-BigData-Spark.html">Statistics,
                                                                ...
                                                                <li class="current-menu-item"><a href="Deep-learning-with-TensorFlow.html">Deep learning with TensorFlow</a></li>
                                                          </ul>
                                                    </li>
        ...
        <div class="main-content">
            ...
            <div class="rs-breadcrumbs breadcrumbs-overlay ">
                ...
                <div class="breadcrumbs-text white-color padding">
                    <h1 class="page-title">Deep learning with TensorFlow</h1>
                    <ul>
                        <li>
                                            ...
                                            <div class="course-overview">
                                                <div class="inner-box">
                                                    ...
                                                    <ul class="review-list">
                                                        ...
                                                        <li>Use cases of Deep Learning</li>
                                                        <li>Human Brain vs. Neural Network</li>
                                                        ...
                                                        <h3>Getting Started with TensorFlow 2.0</h3>
                                                        <li>Introduction to TensorFlow 2.x</li>
                                                        <li>Installing TensorFlow 2.x</li>
                                                        <li>Defining Sequence model layers</li>
                                                        <li>Activation Function</li>
                                                        <li>Layer Types</li>
                                                        <li>Model Compilation</li>
                                                        <li>Model Optimizer</li>
                                                        <li>Model Loss Function</li>
                                                        <li>Model Training</li>
                                                        <li>Digit Classification using Simple Neural Network in TensorFlow 2.x</li>
                                                        <li>Improving the model</li>
                                                        <li>Adding Hidden Layer</li>
                                                        <li>Adding Dropout</li>
                                                        <li>Using Adam Optimizer</li>
                                                        
                                                        <h3>Convolution Neural Network</h3>
                                                         <li>Image Classification Example</li>
                                                        <li>What is Convolution</li>
                                                        <li>Convolutional Layer Network</li>
                                                        <li>Convolutional Layer</li>
                                                        <li>Filtering</li>
                                                        <li>ReLU Layer</li>
                                                        <li>Pooling</li>
                                                        <li>Data Flattening</li>
                                                        <li>Fully Connected Layer</li>
                                                        <li>Predicting a cat or a dog</li>
                                                        <li>Saving and Loading a Model</li>
                                                        <li>Face Detection using OpenCV</li>

                                                        <h3>Regional CNN</h3>
                                                        <li>Regional-CNN</li>
                                                        <li>Selective Search Algorithm</li>
                                                        <li>Bounding Box Regression</li>
                                                        <li>SVM in RCNN</li>
                                                        <li>Pre-trained Model</li>
                                                        <li>Model Accuracy </li>
                                                        <li>Model Inference Time </li>
                                                        <li>Model Size Comparison</li>
                                                        <li>Transfer Learning</li>
                                                        <li>Object Detection – Evaluation</li>
                                                        <li>mAP</li>
                                                        <li>IoU</li>
                                                        <li>RCNN – Speed Bottleneck</li>
                                                        <li>Fast R-CNN</li>
                                                        <li>RoI Pooling</li>
                                                        <li>Fast R-CNN – Speed Bottleneck</li>
                                                        <li>Faster R-CNN</li>
                                                        <li>Feature Pyramid Network (FPN)</li>
                                                        <li>Regional Proposal Network (RPN)</li>
                                                        <li>Mask R-CNN</li>

                                                        <h3>Boltzmann Machine & Autoencoder</h3>
                                                        <li> What is Boltzmann Machine (BM)?</li>
                                                        <li>Identify the issues with BM</li>
                                                        <li>Why did RBM come into picture?</li>
                                                        <li>Step by step implementation of RBM</li>
                                                        <li>Distribution of Boltzmann Machine</li>
                                                        <li>Understanding Autoencoders</li>
                                                        <li>Architecture of Autoencoders</li>
                                                        <li>Brief on types of Autoencoders </li>
                                                        <li>Applications of Autoencoders</li>

                                                        <h3>Generative Adversarial Network(GAN)</h3>
                                                        <li> Which Face is Fake?</li>
                                                        <li>Understanding GAN</li>
                                                        <li>What is Generative Adversarial Network?</li>
                                                        <li>How does GAN work?</li>
                                                        <li>Step by step Generative Adversarial Network implementation</li>
                                                        <li>Types of GAN</li>
                                                        <li>Recent Advances: GAN</li>

                                                       <h3> Emotion and Gender Detection</h3>
                                                        <li>Where do we use Emotion and Gender Detection?</li>
                                                        <li>How does it work?</li>
                                                        <li>Emotion Detection architecture</li>
                                                        <li>Face/Emotion detection using Haar Cascade</li>
                                                        <li>Implementation on Colab</li>


                                                        <h3>Introduction RNN and GRU</h3>
                                                        <li> Issues with Feed Forward Network</li>
                                                        <li>Recurrent Neural Network (RNN)</li>
                                                        <li>Architecture of RNN</li>
                                                        <li>Calculation in RNN</li>
                                                        <li>Backpropagation and Loss calculation</li>
                                                        <li>Applications of RNN</li>
                                                        <li>Vanishing Gradient</li>
                                                        <li>Exploding Gradient</li>
                                                        <li>What is GRU?</li>
                                                        <li>Components of GRU</li>
                                                        <li>Update gate</li>
                                                        <li>Reset gate</li>
                                                        <li>Current memory content</li>
                                                        <li>Final memory at current time step</li>

                                                        <h3>LSTM</h3>
                                                        <li>What is LSTM?</li>
                                                        <li>Structure of LSTM</li>
                                                        <li>Forget Gate</li>
                                                        <li>Input Gate</li>
                                                        <li>Output Gate</li>
                                                        <li>LSTM architecture</li>
                                                        <li>Types of Sequence-Based Model</li>
                                                        ...
                                                        <li>How to increase the efficiency of the model?</li>
                                                        <li>Backpropagation through time</li>
                                                        <li>Workflow of BPTT</li>

                                                        <h3>Auto Image Captioning Using CNN LSTM</h3>
                                                       <li> Auto Image Captioning</li>
                                                        <li>COCO dataset</li>
                                                        <li>Pre-trained model</li>
                                                        <li>Inception V3 model</li>
                                                        <li>Architecture of Inception V3</li>
                                                        <li>Modify last layer of pre-trained model</li>
                                                        <li>Freeze model</li>
                                                        <li>CNN for image processing</li>
                                                        <li>LSTM or text processing</li>
                        ...
                        <div class="video-column col-lg-4">
                            ...
                            <!-- Video Box -->
                                <div class="intro-video media-icon orange-color2">
                                    <img class="video-img" src="assets/images/courses/datascience/tsr.jpeg" alt="Video Image">
