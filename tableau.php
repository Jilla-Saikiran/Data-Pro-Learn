                                           ...
                                           <li > <a href="index.php">Home</a></li>
                                            ...
                                            <li class="menu-item-has-children current-menu-item">
                                                ...
                                                <ul class="sub-menu"> 
                                                    ...
                                                    <li class="current-menu-item"><a href="business.html">Business Analytics</a> 
                                                        <ul class="sub-menu right">
                                                            <li><a href="pl-sql.html">SQL PL-SQL</a></li>
                                                            <li class="current-menu-item"><a href="tableau.html">Tableau, Qlik View & PowerBI</a></li>
        ...
        <div class="main-content">
            ...
            <div class="rs-breadcrumbs breadcrumbs-overlay ">
                ...
                <div class="breadcrumbs-text white-color padding">
                    <h1 class="page-title">Tableau, Qlik View & PowerBI</h1>
                    <ul>
                        <li>
                        ...
                        <div class="video-column col-lg-4">
                            ...
                            <!-- Video Box -->
                                <div class="intro-video media-icon orange-color2">
                                    <img class="video-img" src="assets/images/courses/Business-Analytics/Tableau-Server-1.jpeg" alt="Video Image">
