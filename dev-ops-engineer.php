                                           ...
                                           <li > <a href="index.php">Home</a></li>
                                            ...
                                            <li class="menu-item-has-children current-menu-item">
                                                ...
                                                <ul class="sub-menu"> 
                                                    ...
                                                    <li class="current-menu-item"><a href="dev-ops.html">Dev-ops</a> 
                                                        <ul class="sub-menu right">
                                                            <li class="current-menu-item"><a href="dev-ops-engineer.html">Dev-Ops Engineer</a></li>
        ...
        <div class="main-content">
            ...
            <div class="rs-breadcrumbs breadcrumbs-overlay ">
                ...
                <div class="breadcrumbs-text white-color padding">
                    <h1 class="page-title">Dev-ops Engineering</h1>
                    <ul>
                        <li>
                            <a class="active" href="index.php">Home</a>
                        </li>
                        <li>Dev-ops Engineering</li>
                    </ul>
                </div>
            </div>
            <!-- Breadcrumbs End -->            
                                        ...
                                        <div class="content white-bg pt-30">
                                            ...
                                            <div class="course-overview">
                                                <div class="inner-box">
                                                    ...
                                                    <p>This DevOps Training is to make an individual expert in all DevOps Concepts form the Basics. This  Course is Provided by the Real-Time professionals to make you understand the Real-Time IT Scenario’s and Problems.</p>
                                                    <p>DevOps Training makes you master in the various aspects of the principles of continuous development and deployment, software development operations, continuous integration, automation of configuration management and learn the various tools like Git, Docker, Jenkins, Nagios, Puppet, Ansible and Kubernetes.</p>
                                                    ...
                                                    <h3>What you’ll learn?</h3>
                                                        ...
                                                        <ul class="review-list">
                                                            <li>1 DevOps Course Overview</li>
                                                            <li>  1.1 Objectives of the Course</li>
                                                            <li> 1.2 Pre-requisites</li>
                                                            <li> 1.3 Who Should do the course</li>
                                                            <li> 1.4 DevOps Training Duration</li>
                                                            <li> 2 DevOps Course Content</li>
                                                            <li> 2.1 Introduction to DevOps</li>
                                                            <li> 2.2 Linux Concepts</li>
                                                            <li> 2.3 Automation Concepts</li>
                                                            <li> 2.4 Revision Controls System</li>
                                                            <li> 2.5 Configuration Management</li>
                                                            <li> 2.6 Environments</li>
                                                            <li> 2.7 Build Automation</li>
                                                            <li> 2.8 Tomcat Web Server</li>
                                                            <li> 2.9 Nexus Artifacts/Proxy Tool</li>
                                                            <li> 2.10 Jenkins Framework</li>
                                                            <li> 2.11 LAMP Setup</li>
                                                            <li> 2.11.1 Apache/HTTPD Web Service</li>
                                                            <li> 2.11.2 MySQL Database</li>
                                                            <li> 2.11.3  Installation of WordPress with LAMP</li>
                                                            <li> 2.11.4 Working with Docker</li>
                                                            <li> 2.11.5 System Monitoring</li>
                                                            <li> 2.11.6 DevOps Project Work</li>
                                                            </ul>   
                                                       </ul>
                                                    <h3>Requirements</h3>
                                                    <ul class="review-list">
                                                    <li>Basic knowledge of object-oriented programming is enough</li>
                                                    </ul>
                                                    <h3>Objectives of the Course</h3>
                                                        <ul class="review-list">
                                                            <li>To understand the DevOps Concepts and DevOps Tools</li>
                                                            <li>Deploying the main DevOps tools</li>
                                                            <li>To implement automated system update and DevOps lifecycle</li>
                                                            <li>To understand virtualization and performance</li>
                                                            <li>Providing the perfect security for the entire infrastructure</li>
                                                        </ul>
                                            ...
                                            <div id="accordion3" class="accordion-box">
                                                <div class="card accordion block">
                                                    <div class="card-header" id="headingSeven">
                                                        <h5 class="mb-0">
                                                            <button class="btn btn-link acc-btn" data-toggle="collapse" data-target="#collapseSeven" aria-expanded="true" aria-controls="collapseSeven">This course contain</button>
                                                        </h5>
                                                    </div>
                                                    ...
                                                    <div id="collapseEight" class="collapse" aria-labelledby="headingEight" data-parent="#accordion3">
                                                        <div class="card-body acc-content">
                                                            <div class="content">
                                                                <div class="clearfix">
                                                                    <div class="pull-left">
                                                                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Rem modi sit quam illum rerum recusandae laboriosam minima architecto quia! Nihil, nesciunt similique odit atque dicta dolores iusto culpa. Qui, dolorum!</p>
                                                                    </div>
                        ...
                        <div class="video-column col-lg-4">
                            ...
                            <!-- Video Box -->
                                <div class="intro-video media-icon orange-color2">
                                    <img class="video-img" src="assets/images/courses/dev-ops/dev-ops.jpeg" alt="Video Image">
